...
// NewUser 创建菜单管理实例
func NewUser(m *cmodel.Common, e *casbin.Enforcer) *User {
	return &User{
		UserModel: m.User,
		RoleModel: m.Role,
		Enforcer:  e,
...
// QueryPage 查询分页数据
func (a *User) QueryPage(ctx context.Context, params schema.UserQueryParam, pp *cschema.PaginationParam) ([]*schema.UserPageShow, *cschema.PaginationResult, error) {
