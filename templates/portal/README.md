...
```
go get -v [[.project]]/cmd/[[.project]]
```

### 运行

> root 用户的用户名及密码在配置文件(`configs/[[.project]]/config.toml`)中，默认为：root/abc-123
...
```bash
[[.project]] -c ./configs/[[.project]]/config.toml -m ./configs/[[.project]]/model.conf -swagger ./internal/app/swagger
```
...
- [gin-admin-react](https://[[.project]]-react)：基于[Ant Design React](https://ant.design)的实现版本
...
[reportcard-url]: https://goreportcard.com/report/[[.project]]
[reportcard-image]: https://goreportcard.com/badge/[[.project]]
[godoc-url]: https://godoc.org/[[.project]]
[godoc-image]: https://godoc.org/[[.project]]?status.svg
