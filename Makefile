...
start: 
	...
	$(SERVER_BIN) -c ./configs/ginadmin/config.toml -m ./configs/ginadmin/model.conf -swagger ./internal/app/swagger
...
clean:
	rm -rf data release $(SERVER_BIN) ./internal/app/ginadmin/test/data ./internal/app/test/data
